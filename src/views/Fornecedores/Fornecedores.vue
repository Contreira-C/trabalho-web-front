    ...
    >
        ...
        <div  v-for="item in Lista" class="row border p-2 bg-light text-center align-items-center" style="height: 55px">
            ...
            <div class="col-1 ms-auto">
                <button class="btn botao1 d-flex" @click="openModal(true,1)">
...
<script>
    ...
    import Modal from './modalFornecedores.vue'
    export default {
        components: {
            List,
            Modal
        ...
        methods:{
            requisicao: async function(){
                const response = await this.$apiAxios.get('http://localhost:5000/fornecedores', {
                    headers: {
